...
function warningPrompt() {
    ...
    confirmationWindow = Ext.create('Ext.window.Window', {
        ...
        resizable: false,
        shadow: false,
        html: 'Ars Against Humanity is a Google+ Hangout app designed for playing <a href="http://www.cardsagainsthumanity.com/index2.html" target="_blank">Cards Against Humanity</a>, with an Ars extension. Please be aware this game is intended for mature audiences. <br><br> Hangouts Against Humanity is available on Github where you can view the source, wiki, and submit issues <a href="https://github.com/samurailink3/hangouts-against-humanity" target="_blank">here</a> ',
        buttons: [
            {
